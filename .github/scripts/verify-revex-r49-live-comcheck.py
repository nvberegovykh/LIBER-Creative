#!/usr/bin/env python3
"""Live, non-production COMcheck transport acceptance for REVEX r49.

Uses synthetic NYC project identity/facts only. It proves the official service can
accept the generated current-project CXL, calculate the envelope backstop, and
return a genuine PDF before a production publisher spends time on Revit/OS/E+.
"""
