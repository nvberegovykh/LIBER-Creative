...
console.log(JSON.stringify({schema:'liber.revex.r71-companion-state-qa.v1',status:'PASSED',viewer:{canonicalVisibilityBeforeHydration:true,appearanceOutsideGeometry:true},projectState:{appearanceClearsOnSwitch:true,appearanceHydrates:true,appearanceLiveSync:true},inspector:{remoteAppearanceRefresh:true,sourceTraceable:true},cache:{revexCoreNetworkAuthoritative:true}},null,2));
