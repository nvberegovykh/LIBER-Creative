...
must(verify,'window.RevexCoffeeAreaObserver.verify','post-output verifier');
...
if(expected?.expectedDelta?.geometryMutation===true)throw new Error('Expected-output contract may not allow geometry mutation');
