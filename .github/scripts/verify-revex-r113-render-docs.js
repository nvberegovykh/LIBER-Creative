...
const docs=read('docs/liber-apps/apps/revex/docs-presentation-r113.js');
...
must(loader,"docs-presentation-r113.js?v=20260817r113-docs1",'r113 Docs owner must be loaded');
...
forbid(docs,'MutationObserver','Docs presentation must remain event-driven');
must(docs,'const clean=search.cloneNode(true)','r113 must remove the retired r110 search listener before owning presentation');

console.log(JSON.stringify({schema:'liber.revex.r113.render-docs.v1',status:'PASSED',render:{explicitStorage:true,stagedErrors:true},docs:{oneRevisionPerSet:true,fullAndLinkedSheets:true,revisionSelector:true},energyChanged:false},null,2));
