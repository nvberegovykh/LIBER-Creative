...
AUTOMATIC FLOW
Companion uploads the immutable revision -> broker verifies user/project/revision -> worker verifies hashes, gate and EPW -> reads only visible immutable Revit EN/Z page PDFs -> GeometryCo -> Baseline/Proposed OpenStudio 3.10 + EnergyPlus -> review package -> filled EN-1 workbook -> current-project COMcheck CXL + audit -> Storage/Firestore -> Companion.
