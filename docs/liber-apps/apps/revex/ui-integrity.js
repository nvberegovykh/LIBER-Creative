(function(root){
  ...
  function loadCurrentRepairs(){
    ...
    loadScript('observer-elevator-workshop-r146.js?v=20260915r148-workshop3','observer-elevator-workshop-r146');
  ...
  console.log('[REVEX] UI integrity '+BUILD,{projectId:'visible',restoreAll:'first-capture+canonical-store-commit',energy:'r125-preserved+wallt-review',wallt:'visible-helper+bounded-fixer-adapters+24h-history+mobile-actions-menu',observer:'r143-focus+r144-native-family-inspection+r145-elevator-plan+r148-isolated-workshop-through-s6',moduleLoad:'r126-convergence+r133-mobile-safe2+r137-fixer+r138-wallt-ui+r142-bottom-sheet+r148-observer-workshop',liveWorkerEdge:'r116-pipeline-aware-recovery',ui:'r109-svg+r122-walk+r133-safe-area+r142-reused-node-sheet',docs:'r134-full-set-linked-pages+r126-ownership-guard+r133-content-height-mobile-stack',texture:'instance-uv>type-texture>design-color>revit',render:'google-gemini-client+docked-owner+qwen-shadow+interaction-freeze-guard',chat:'r136-project-isolated-secure-chat-native-ui',issues:'revexIssues+all-active-default+empty-selection-inspector',history:'technical-NYC-day+wallt-24h',dailyReport:'separate-post-sync-worker',blocks:'r135-walk-target+face-host+external-event',bimProperties:'r117-preserved',qaHardStop:'unchanged',targetFps:30,spatialObjects:'invisible'});
})(window);