(function(root){
  'use strict';
  const BUILD='20260820r147-release1';
  ...
  function loadReviewIntegrity(){if(document.querySelector('script[data-revex-review-integrity]'))return;const script=document.createElement('script');script.type='module';script.dataset.revexReviewIntegrity='1';script.src='review-integrity-r50.js?v=20260820r147-release1';script.onerror=()=>root.__revexBrowserDiagnostics?.emit?.('ERROR','REVIEW_RUNTIME','Could not load review-integrity-r50.js.',{initiator:'ui integrity loader'});document.head.appendChild(script);}
  function loadCurrentRepairs(){
    ...
    loadScript('energy-identity-en1-r89.js?v=20260820r147-release1','energy-identity-en1-r89');
    loadScript('energy-replay-r95.js?v=20260817r116-final-energy1','energy-replay-r95');
    loadScript('energy-agent-review.js?v=20260820r147-release1','energy-agent-review','module');
    ...
    loadScript('viewer-interaction-r85-loader.js?v=20260820r147-release1','viewer-interaction-r85-loader');
    loadScript('ui-polish-r109.js?v=20260820r147-release1','ui-polish-r109');
    loadScript('viewer-texture-r115.js?v=20260817r126-texture-precedence1','viewer-texture-r115');
    loadScript('docs-pages-r115.js?v=20260820r147-release1','docs-pages-r115');
    ...
    loadScript('docs-convergence-r126.js?v=20260820r147-release1','docs-convergence-r126');
    loadScript('issues-convergence-r126.js?v=20260820r147-release1','issues-convergence-r126');
    loadScript('issues-inspector-r126.js?v=20260817r126-empty-selection-issues1','issues-inspector-r126');
    loadScript('history-daily-r126.js?v=20260820r147-release1','history-daily-r126');
    loadScript('blocks-palette-r126.js?v=20260820r147-release1','blocks-palette-r126');
    ...
    loadScript('experience-r144.js?v=20260820r147-release1','experience-r144');
  }
  ...
  console.log('[REVEX] UI integrity '+BUILD,{projectId:'visible',restoreAll:'first-capture+canonical-store-commit',energy:'r125-preserved+wallt-review',wallt:'context-aware+chat-excluded+mobile-actions-menu',moduleLoad:'r126-convergence+r133-mobile-safe2+r137-fixer+r138-wallt-ui+r142-bottom-sheet+r144-experience',liveWorkerEdge:'r116-pipeline-aware-recovery',ui:'r144-final-presentation+r109-svg+r122-walk+r133-safe-area+r142-reused-node-sheet',docs:'r144-disclosures+mobile-viewer-sheet+r134-full-set-linked-pages+r126-ownership-guard',texture:'instance-uv>type-texture>design-color>revit',render:'google-gemini-client+docked-owner+r144-hierarchy+interaction-freeze-guard',chat:'r136-project-isolated-secure-chat-native-ui',issues:'revexIssues+all-active-default+empty-selection-inspector',history:'technical-NYC-day+wallt-24h',dailyReport:'separate-post-sync-worker',blocks:'discoverable-provider+explicit-insert+walk-target+face-host+external-event',bimProperties:'r117-preserved',measure:'two-visible-points+architectural-1/16in',sectionPicking:'active-clip-volume',qaHardStop:'unchanged',targetFps:30,spatialObjects:'invisible'});
})(window);
