(function(root){
  ...
  function loadCurrentRepairs(){
    ...
    loadScript('mobile-design-r139.js?v=20260819r139-mobile-design1','mobile-design-r139');
  ...
  console.log('[REVEX] UI integrity '+BUILD,{projectId:'visible',restoreAll:'first-capture+canonical-store-commit',energy:'r125-preserved+wallt-review',wallt:'visible-helper+bounded-fixer-adapters+24h-history',moduleLoad:'r126-convergence+r133-mobile-safe+r139-mobile-design+r137-fixer+r138-wallt-ui-last',liveWorkerEdge:'r116-pipeline-aware-recovery',ui:'r122-mobile+r126-responsive+r133-safe-area-scroll+r139-design-selector-icons',docs:'r134-full-set-linked-pages+r126-ownership-guard+r133-mobile-stack',texture:'instance-uv>type-texture>design-color>revit',render:'google-gemini-client+docked-owner+qwen-shadow+interaction-freeze-guard',chat:'r136-project-isolated-secure-chat',issues:'revexIssues+all-active-default+empty-selection-inspector',history:'technical-NYC-day+wallt-24h',dailyReport:'separate-post-sync-worker',blocks:'r135-walk-target+face-host+external-event',bimProperties:'r117-preserved',qaHardStop:'unchanged',targetFps:30,spatialObjects:'invisible'});
})(window);