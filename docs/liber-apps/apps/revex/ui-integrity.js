(function(root){
  ...
  console.log('[REVEX] UI integrity '+BUILD,{projectId:'visible',reviewRuntime:'r49-review2+r85-section-selection',docsPages:'native-pdf-page-navigation-no-main-thread-split',viewerPolish:'r68',appearance:'single-owner-r75+auth-rehydrate-r85',modelFilter:'single-owner-r75',viewerRuntime:'r75-preemptible+r85-adaptive-exact',mobileBim:'single-bottom-drawer-r85',selection:'element-section-empty-r85',walkLevels:'rendered-world-r85',materialIntegration:'embedded-properties-architextures-user-download-auto-apply',restoreAll:'delegated-setDoc-r85',energyDiagnostics:'current-revision-only-r80',targetFps:30,spatialObjects:'invisible'});
})(window);
