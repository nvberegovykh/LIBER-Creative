(function(root){
  ...
  console.log('[REVEX] UI integrity '+BUILD,{projectId:'visible',restoreAll:'first-capture+canonical-store-commit',energy:'r125-preserved+wallt-review',wallt:'visible-helper+bounded-fixer-adapters+24h-history+r140-topbar-dock',moduleLoad:'r126-convergence+r133-mobile-safe+r137-fixer+r138-wallt-ui+r140-mobile-final',liveWorkerEdge:'r116-pipeline-aware-recovery',ui:'r122-walk-touch+r126-responsive+r133-safe-area+r140-single-mobile-owner',docs:'r134-full-set-linked-pages+r126-ownership-guard+r140-mobile-flow',texture:'instance-uv>type-texture>design-color>revit',render:'google-gemini-client+docked-owner+qwen-shadow+interaction-freeze-guard',chat:'r136-project-isolated-secure-chat+r140-full-frame',issues:'revexIssues+all-active-default+empty-selection-inspector',history:'technical-NYC-day+wallt-24h',dailyReport:'separate-post-sync-worker',blocks:'r135-walk-target+face-host+external-event',bimProperties:'r117-preserved',qaHardStop:'unchanged',targetFps:30,spatialObjects:'invisible'});
})(window);