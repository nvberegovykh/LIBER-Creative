...
try {
  ...
  Invoke-Checked "Verify r75 consolidated nonblocking viewer + embedded material integration" $Node @(".github\scripts\verify-revex-r72-nonblocking-viewer.js") $RepoRoot
